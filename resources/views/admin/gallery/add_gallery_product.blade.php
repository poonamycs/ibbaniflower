      ...
      <div class="span12">
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <form enctype="multipart/form-data" class="form-horizontal" method="post" action="{{ url('/admin/add-gallery-images/') }}" name="add_image" id="add_image" novalidate="novalidate"> {{ csrf_field() }}
        ...
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <table class="table table-bordered data-table">
              ...
              <tbody>
                @foreach($galleryproduct as $image)
                <tr class="gradeX">
                  ...
                  <td style="text-align:center;"><a onclick="return confirm('Are you sure you want to delete this Image?');" href="{{ url('/admin/delete-gallery-image/'.$image->id) }}" class="btn btn-danger btn-mini" title="Delete Product Image">Delete</a></td>
                </tr>
                @endforeach
