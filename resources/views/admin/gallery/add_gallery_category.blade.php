...
<div id="content">
    <div id="content-header">
        <div id="breadcrumb"> <a href="{{ url('admin/dashboard') }}" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a>  
            <a href="#">Gallery</a>  <a href="#" class="current">View Album Type</a> 
        </div>
        <h1>Categories</h1>
    </div>
            ...
            <div class="span12">
                <div class="widget-box">
                    ...
                    <div class="widget-content nopadding">
                        <form class="form-horizontal" method="post" action="{{ url('/admin/album-type') }}" name="add_album_type" id="add_album_type" novalidate="novalidate" enctype="multipart/form-data">{{ csrf_field() }}
