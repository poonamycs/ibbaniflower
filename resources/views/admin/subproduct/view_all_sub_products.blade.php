      ...
      <div class="span12">
        <div class="widget-box">
          <div class="widget-title"> <span class="icon"><i class="icon-th"></i></span>
            <h5>All Products</h5>
            <a href="{{ url('/admin/add-sub-product') }}"><button style="float: right; margin: 3px 3px;" class="btn btn-success btn-xs"><i class="fa fa-plus"></i> Add Sub Product</button></a>
              ...
              <tbody>
                ...
                <tr class="gradeX">
                    ...
                    <td class="text-center">
                        ...
                        <img src="{{ asset('/images/backend_images/subproducts/small/'.$product->image) }}" style="height: 40px;">
                        @endif
                    </td>
                    <td style="text-align: center;">
                    <form action="{{ url('admin/subproduct-approved/'.$product->id) }}" method="post">
                        {{ csrf_field() }}
                    ...
                    <td class="text-center">
                        ...
                        <a rel="{{ $pid }}" rel1="delete-subproduct" href="javascript:" class="btn btn-danger deletesubproduct" title="Delete sub product"><i class="fa fa-trash"></i></a>
                    </td>
                </tr>
                <div id="myModal{{ $product->id }}" class="modal hide">
                    ...
                    <div class="modal-body">
                        ...
                        <center><img src="{{ asset('/images/backend_images/subproducts/small/'.$product->image) }}"></center>
                    </div>
                </div>
                @endforeach
