                ...
                <div class="container container-ver2">
                    <div class="box cart-container">
                        <table class="table cart-table space-30">
                            ...
                            <tbody>
                                <tr class="item_cart">
                                    <td class="product-photo"><img src="{{ asset('front/img/340x420.png') }}" alt="Futurelife"></td>
                                ...
                                <tr class="item_cart">
                                    ...
                                    <td class="total-price"></td>
                                    <td class="product-remove"><a class="remove" href="#" title="close"><img src="{{ asset('front/img/icon-delete-cart.png') }}" alt="close"></a></td>
                                </tr>
                                <tr class="item_cart">
                                    <td class="product-photo"><img src="{{ asset('front/img/340x420.png') }}" alt="Futurelife"></td>
