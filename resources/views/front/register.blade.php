...
@section('content')
	...
	<link rel="stylesheet" type="text/css" href="{{ asset('front/css/style-login.css') }}">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="register box space-50">
                            ...
                            <form action ="{{ url('/user-register') }}" class="form-horizontal" method="POST" id="registerform">
                                @csrf
                                <div class="group box space-20">
                                ...
                                <div class="group box space-20">
                                    <label class="control-label" for="inputemailres">Email Address *</label>
                                    <input class="form-control" type="text" name="email" placeholder="Your email" id="inputemailres">
                                </div>
                                <div class="group box space-20">
