		...
		<div class="row">
			<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
				<div class="img-color-1">
					...
					<img src="{{ asset('/images/frontend_images/50x70.png') }}" class="img-responsive" alt="img-holiwood">
					</div>
				<h1>Our Address</h1>
			...
			<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
				<div class="img-color-2">
					<div class="img-content">
					<img src="{{ asset('/images/frontend_images/62x61.png') }}" class="img-responsive" alt="img-holiwood">
				</div>
				<h1>Phone Number</h1>
			...
			<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
				<div class="img-color-3">
					<div class="img-content">
					<img src="{{ asset('/images/frontend_images/77x60.png') }}" class="img-responsive" alt="img-holiwood">
				</div>
				<h1>Email Address</h1>
