			...
			<div class="col-lg-9 col-md-9 col-sm-12 col-xs-12 content-blog">
				...
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pagi">
					<ul class="pagination">
						...
						<li><a href="#">03</a></li>
						<li><a href="#">04</a></li>
						<li><a href="#"><img src="{{ asset('/images/frontend_images/Next.png') }}" class="img-responsive" alt="img-holiwood"></a></li>
					</ul>
				</div>
			</div>
<!-- sidebar -->
					...
					<li class="list-group-item">RECENT POSTS</li>
  					<li class="list-group-item list-item-2">
  						<div class="col-lg-5 col-md-5 col-sm-12 col-xs-12">
  							<a href="#"><img src="{{ asset('/images/frontend_images/blog-1.jpg') }}" class="img-responsive" alt="img-holiwood"></a>
  						</div>
	...
	<link rel="stylesheet" type="text/css" href="{{ asset('css/frontend_css/style-shop.css') }}">
	<link rel="stylesheet" type="text/css" href="{{ asset('css/frontend_css/style-res-shop.css') }}">
