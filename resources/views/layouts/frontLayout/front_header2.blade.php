...
<nav class="hidden-xs">
	...
	<div class="container">
		...
		<div class="collapse navbar-collapse col-lg-6 col-md-6 col-sm-12 col-xs-12" id="myNavbar">
			...
			<ul class="nav navbar-nav menu-main">
				...
				<li class="contact-menu"><a href="{{ url('/contact') }}">Trending</a><figure id="contact-1" class="hidden-sm hidden-xs"></figure></li>
				...
				<li class="contact-menu"><a href="{{ url('/contact') }}">Bloom Studio</a><figure id="contact-1" class="hidden-sm hidden-xs"></figure></li>
	...
	<ul class="nav navbar-nav navbar-right col-lg-4 col-md-4 col-sm-5 col-xs-5" style="padding-top:40px;padding-left:210px">
	@if(empty(Auth::check()))
