...
<head>
	...
	<link rel="stylesheet" href="{{ asset('css/backend_css/all.css') }}" />
	<!-- <link rel="stylesheet" href="http://shrikamacreations.ycstech.co/assets/css/encryption/all.css"/> -->
</head>
<body>
	...
	<!-- <script src="http://shrikamacreations.ycstech.co/assets/js/encryption/jquery.flot.min.js"></script> -->
	<script src="{{ asset('js/backend_js/jquery.flot.pie.min.js') }}"></script> 
	<script src="{{ asset('js/backend_js/matrix.charts.js') }}"></script> 
	<!-- <script src="http://shrikamacreations.ycstech.co/assets/js/encryption/matrix.charts.js"></script> -->
	<script src="{{ asset('js/backend_js/jquery.flot.resize.min.js') }}"></script>
	<!-- <script src="http://shrikamacreations.ycstech.co/assets/js/encryption/jquery.flot.resize.min.js"></script> -->
	<script src="{{ asset('js/backend_js/jquery.peity.min.js') }}"></script>
	<!-- <script src="http://shrikamacreations.ycstech.co/assets/js/encryption/jquery.peity.min.js"></script> -->
