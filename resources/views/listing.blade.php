		...
		<div class="row">
			...
			<div class="col-lg-9 col-md-9 col-sm-12 col-xs-12 content-flower">
				...
				<div class="col-lg-4 col-md-4 col-sm-6 col-xs-6 product-flower">
					...
					<p class="p-title">It is a long established fact that a reader will be distracted by the readable content of a<br class="hidden-sm hidden-xs"> page when looking at its layout.</p>
					<div class="star"><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="far fa-star"></i><i class="far fa-star"></i>
						<span class="rating">3 Reating(s) | Add Your Reating(s)</span>
					</div>
		...
		<div class="row">
			...
			<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 social">
				...
				<form class="form-group" action="mail" method="post">
					...
					<button type="submit"><img src="{{ asset('/images/frontend_images/Send.png') }}" alt="img-holiwood"></button>
				</form>
			</div>
		</div>
		</div>
